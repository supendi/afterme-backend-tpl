...
namespace AfterMe.ConsoleApp
{
    ...
    class Program
    {
        ...
        static IAccountRepository accountRepository = new AccountSqlServer(dbContext);
        static AccountService accountService = new AccountService(accountRepository, passwordHasher);
        ...
        static void GetAccount(int accountId)
        {
        ...
        static void UpdateAccount(int accountId)
        {
            var accountFromDatabase = accountService.Get(accountId);
